      ...
      <div className="flex items-center gap-2.5">
        ...
        {isVisible && (
          <div
            ...
            className="back-to-top flex h-12 w-12 cursor-pointer items-center justify-center rounded-full bg-white text-dark_black shadow-md transition duration-300 ease-in-out hover:bg-gray-200 border border-dark_black/10"
          >

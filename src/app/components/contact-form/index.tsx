          ...
          <div className='flex flex-col gap-10 md:gap-20'>
            <div className='relative flex flex-col text-center items-center'>
              <h2 className='font-medium w-full max-w-32'>
                <TextGenerateEffect words="Kami ingin mendengar darimu, Mari" duration={0.5}  />
                <TextGenerateEffect
                  words="terhubung"
                  delay={1.5}
              ...
              <div className='flex flex-col items-center gap-5 text-center max-w-xl mx-auto p-6 rounded-lg bg-green/20 dark:bg-white/5'>
                <div className='flex'>
                  ...
                  <h5 className='text-green dark:text-green'>
                    Email berhasil terkirim. Kami akan segera menghubungi Anda.
                  </h5>
                </div>
                ...
                <div className='flex flex-col md:flex md:flex-row gap-6'>
                  <div className='w-full'>
                    ...
                    <select
                      ...
                      <option value='Ecommerce'>Paket Developer Bundle</option>
                      <option value='Specialist'>Kerjasama Reseller</option>
                      <option value='Specialist'>Pesanan Kustom untuk Event</option>
                    </select>
                  </div>
                  <div className='w-full'>
                    <label htmlFor='budget'>Perkiraan Jumlah Pesanan</label>
                    <select
                      ...
                      <option value='$10000'>1 - 5 Botol</option>
                      <option value='$50500'>6 - 20 Botol</option>
                      <option value='$50500'>Pesanan Grosir (20+ Botol)</option>
                    </select>
                  </div>
                </div>
                <div className='w-full'>

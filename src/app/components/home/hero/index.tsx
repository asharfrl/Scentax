        ...
        <div className='container relative z-10'>
          <div ref={ref} className='flex flex-col gap-8'>
            ...
            <div
              ...
              <h1>
                <TextGenerateEffect words="The Syntax of Scent" />
                <TextGenerateEffect
                  words="Precision in Every Note"
                  delay={0.8}
                  className="italic font-normal instrument-font"
                />
              </h1>
              <p className='max-w-38 text-dark_black/60 dark:text-white/60'>
                Tingkatkan kehadiranmu dengan aroma unisex yang diracik melalui presisi layaknya algoritma.
                Scentax bukan sekadar parfum, ini adalah source code untuk kepercayaan dirimu.
              </p>
            </div>
            ...
            <motion.div
              ...
              <div className='flex flex-col items-center justify-center gap-8 w-full sm:flex-row'>
                ...
                <Link
                  href='/#aboutus'
                  className='group bg-dark_black text-white dark:bg-white dark:text-dark_black font-medium flex flex-row justify-between items-center py-2 px-5 rounded-full max-w-64 w-full md:py-3 border border-dark_black dark:border-white transition-all duration-200 ease-in-out hover:bg-transparent hover:text-dark_black dark:hover:bg-transparent dark:hover:text-white'>
                  ...
                  <svg
                    ...
                    <path
                      ...
                      className='stroke-dark_black dark:stroke-white transition-colors duration-500 ease-in-out group-hover:stroke-white dark:group-hover:stroke-dark_black'
                      strokeWidth='1.66667'
                      strokeLinecap='round'
                      strokeLinejoin='round'
                    />
